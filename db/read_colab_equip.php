...
$querySelect = $link->query("select * from tb_colab_equip, tb_colaborador, tb_equipamento where tb_colaborador.id = tb_colab_equip.id_colab AND tb_equipamento.id_equip = tb_colab_equip.id_equip ORDER BY nome ASC");
